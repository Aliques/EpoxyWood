...
export const TabsDesktop = () => {
    ...
    return (
        <div className={s.container}>
            <input className={sl(s.radio, s.tab_photo)} id="tab_photo" name="group" type="radio" onChange={showPhoto} ref={tab_photo}/>
            <input className={sl(s.radio, s.tab_video)} id="tab_video" name="group" type="radio" onChange={showVideo} ref={tab_video}/>
